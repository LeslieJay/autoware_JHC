...
class LiveObstaclePublisher(Node):
    ...
    def timer_callback(self):
        ...
        obj.kinematics.pose_with_covariance.pose.position.y = -120.0
        obj.kinematics.pose_with_covariance.pose.position.z = 1.46
        # obj.kinematics.pose_with_covariance.pose.position.x = 22.5
        # obj.kinematics.pose_with_covariance.pose.position.y = -46.8
        ...
        obj.kinematics.pose_with_covariance.pose.orientation.z = -0.2588
        obj.kinematics.pose_with_covariance.pose.orientation.w = 0.9659
